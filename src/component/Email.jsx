...
const Email = () =>{
  ...
  const composition_input_xl = 'lg:min-h-[56px] lg:pl-8 lg:placeholder:text-16'
  ...
  const composition_button_xl = 'lg:w-[100px]'
  const composition_icon_error ='absolute top-1/4 right-16'
  const composition_icon_error_xl = 'lg:right-24'
